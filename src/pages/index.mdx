...
## Logging into the Environment
  ...
  The first time that you login, you will see a **welcome** screen that allows you to take a guided tour.  You can either follow the guided tour or you can cancel by clicking the **X** in the upper right corner.
   ![](images/cancelTour.png) 
